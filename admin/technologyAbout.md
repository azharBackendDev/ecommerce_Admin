...
MORGAN :
About morgan why used morgan :- generates logs that capture key details of each HTTP request, such as the request method (GET, POST, etc.), URL, HTTP status code, response time, and content length.
